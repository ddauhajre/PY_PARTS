...
class ROMS_run(object):
    ...
    def set_paths(self):
	   ...
	   self.path_output   = '/data/project3/ddauhajre/MidCal/usw4_sbc/his/'
           self.path_ts_uv = '/data/project3/ddauhajre/MidCal/usw4_sbc/ts_uv/'
	   self.path_grid = '/data/project3/ddauhajre/MidCal/usw4_sbc/input/'
